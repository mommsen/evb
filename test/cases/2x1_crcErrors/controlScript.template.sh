...
echo "1 CRC error on FED 1"
setParam FEROL1_SOAP_HOST_NAME FEROL1_SOAP_PORT evb::test::DummyFEROL 1 nbCRCerrors unsignedInt 1

sleep 2

echo "3 CRC errors on FED 5"
setParam FEROL5_SOAP_HOST_NAME FEROL5_SOAP_PORT evb::test::DummyFEROL 5 nbCRCerrors unsignedInt 3

sleep 2

echo "2 CRC errors on FED 7"
setParam FEROL7_SOAP_HOST_NAME FEROL7_SOAP_PORT evb::test::DummyFEROL 7 nbCRCerrors unsignedInt 2
...
if [[ $nbEventsWithCRCerrorsBU0 -ne 6 ]]
then
...
if [[ $nbEventDumps -ne 0 ]]
then
  echo "Test failed: expected 0"
  exit 1
fi

echo "100 CRC errors on FED 6"
setParam FEROL6_SOAP_HOST_NAME FEROL6_SOAP_PORT evb::test::DummyFEROL 6 nbCRCerrors unsignedInt 100
...
nbEventsWithCRCerrorsBU0=$(getParam BU0_SOAP_HOST_NAME BU0_SOAP_PORT evb::BU 0 nbEventsWithCRCerrors xsd:unsignedLong)
echo "BU0 nbEventsWithCRCerrors: $nbEventsWithCRCerrorsBU0"
if [[ $nbEventsWithCRCerrorsBU0 -le 10 ]]
then
  echo "Test failed: expected more than 10"
  exit 1
fi
