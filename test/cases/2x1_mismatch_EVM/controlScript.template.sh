...
echo "Skipping an event on FED 2"
setParam FEROL2_SOAP_HOST_NAME FEROL2_SOAP_PORT evb::test::DummyFEROL 2 skipNbEvents unsignedInt 1
sleep 5
...
echo "Duplicate an event on FED 0"
setParam FEROL0_SOAP_HOST_NAME FEROL0_SOAP_PORT evb::test::DummyFEROL 0 duplicateNbEvents unsignedInt 1
sleep 5
