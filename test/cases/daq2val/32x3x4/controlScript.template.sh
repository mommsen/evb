...
nbCounterServerFEROL16=`getParam FEROL16_SOAP_HOST_NAME FEROL16_SOAP_PORT Client 16 counter  xsd:unsignedLong`
nbCounterServerFEROL17=`getParam FEROL17_SOAP_HOST_NAME FEROL17_SOAP_PORT Client 17 counter  xsd:unsignedLong`
nbCounterServerFEROL18=`getParam FEROL18_SOAP_HOST_NAME FEROL18_SOAP_PORT Client 18 counter  xsd:unsignedLong`
nbCounterServerFEROL19=`getParam FEROL19_SOAP_HOST_NAME FEROL19_SOAP_PORT Client 19 counter  xsd:unsignedLong`
nbCounterServerFEROL20=`getParam FEROL20_SOAP_HOST_NAME FEROL20_SOAP_PORT Client 20 counter  xsd:unsignedLong`
nbCounterServerFEROL21=`getParam FEROL21_SOAP_HOST_NAME FEROL21_SOAP_PORT Client 21 counter  xsd:unsignedLong`
nbCounterServerFEROL22=`getParam FEROL22_SOAP_HOST_NAME FEROL22_SOAP_PORT Client 22 counter  xsd:unsignedLong`
nbCounterServerFEROL23=`getParam FEROL23_SOAP_HOST_NAME FEROL23_SOAP_PORT Client 23 counter  xsd:unsignedLong`
nbCounterServerFEROL24=`getParam FEROL24_SOAP_HOST_NAME FEROL24_SOAP_PORT Client 24 counter  xsd:unsignedLong`
nbCounterServerFEROL25=`getParam FEROL25_SOAP_HOST_NAME FEROL25_SOAP_PORT Client 25 counter  xsd:unsignedLong`
nbCounterServerFEROL26=`getParam FEROL26_SOAP_HOST_NAME FEROL26_SOAP_PORT Client 26 counter  xsd:unsignedLong`
nbCounterServerFEROL27=`getParam FEROL27_SOAP_HOST_NAME FEROL27_SOAP_PORT Client 27 counter  xsd:unsignedLong`
nbCounterServerFEROL28=`getParam FEROL28_SOAP_HOST_NAME FEROL28_SOAP_PORT Client 28 counter  xsd:unsignedLong`
nbCounterServerFEROL29=`getParam FEROL29_SOAP_HOST_NAME FEROL29_SOAP_PORT Client 29 counter  xsd:unsignedLong`
nbCounterServerFEROL30=`getParam FEROL30_SOAP_HOST_NAME FEROL30_SOAP_PORT Client 30 counter  xsd:unsignedLong`
nbCounterServerFEROL31=`getParam FEROL31_SOAP_HOST_NAME FEROL31_SOAP_PORT Client 31 counter  xsd:unsignedLong`
...
echo "Client 16 nbEvtsBuilt: $nbCounterServerFEROL16"
echo "Client 17 nbEvtsBuilt: $nbCounterServerFEROL17"
echo "Client 18 nbEvtsBuilt: $nbCounterServerFEROL18"
echo "Client 19 nbEvtsBuilt: $nbCounterServerFEROL19"
echo "Client 20 nbEvtsBuilt: $nbCounterServerFEROL20"
echo "Client 21 nbEvtsBuilt: $nbCounterServerFEROL21"
echo "Client 22 nbEvtsBuilt: $nbCounterServerFEROL22"
echo "Client 23 nbEvtsBuilt: $nbCounterServerFEROL23"
echo "Client 24 nbEvtsBuilt: $nbCounterServerFEROL24"
echo "Client 25 nbEvtsBuilt: $nbCounterServerFEROL25"
echo "Client 26 nbEvtsBuilt: $nbCounterServerFEROL26"
echo "Client 27 nbEvtsBuilt: $nbCounterServerFEROL27"
echo "Client 28 nbEvtsBuilt: $nbCounterServerFEROL28"
echo "Client 29 nbEvtsBuilt: $nbCounterServerFEROL29"
echo "Client 30 nbEvtsBuilt: $nbCounterServerFEROL30"
echo "Client 31 nbEvtsBuilt: $nbCounterServerFEROL31"
...
if [[ $nbCounterServerFEROL16 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL17 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL18 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL19 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL20 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL21 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL22 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL23 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL24 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL25 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL26 -lt 100 ]]
hen
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL27 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL28 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL29 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL30 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
if [[ $nbCounterServerFEROL31 -lt 100 ]]
then
  echo "Test failed"
  exit 1
fi
